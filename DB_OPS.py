...
def update_metrics_db(conn,Sample,WGS_Bases_Over_Q30,WGS_Min_Aligned_Reads_Delivered,Raw_Mean_Coverage,WGS_Dedup_Coverage,Median_Insert_Size,Raw_Duplication_Rate,WGS_Contamination,Raw_Reads_Count,WTS_Aligned_Reads,WTS_Exonic_Rate, WTS_rRNA_contamination,Concordance,Purity,Yellow_Flags,Red_Flags,Raw_Median_Insert_Size,Raw_Mean_Insert_Size):
    ...
    if result:
        ...
        cur.execute(f"INSERT INTO KEY_METRICS (Sample,WGS_Bases_Over_Q30,WGS_Min_Aligned_Reads_Delivered,Raw_Mean_Coverage,WGS_Dedup_Coverage,Median_Insert_Size,Raw_Duplication_Rate,WGS_Contamination,Raw_Reads_Count,WTS_Exonic_Rate,WTS_Aligned_Reads,WTS_rRNA_contamination,Concordance,Purity,Yellow_Flags,Red_Flags,Raw_Median_Insert_Size,Raw_Mean_Insert_Size) VALUES ('{Sample}','{WGS_Bases_Over_Q30}','{WGS_Min_Aligned_Reads_Delivered}','{Raw_Mean_Coverage}','{WGS_Dedup_Coverage}','{Median_Insert_Size}','{Raw_Duplication_Rate}','{WGS_Contamination}','{Raw_Reads_Count}','{WTS_Exonic_Rate}','{WTS_Aligned_Reads}','{WTS_rRNA_contamination}','{Concordance}','{Purity}','{Yellow_Flags}','{Red_Flags}','{Raw_Median_Insert_Size}','{Raw_Mean_Insert_Size}')")
    else:
        cur.execute(f"INSERT INTO KEY_METRICS (Sample,WGS_Bases_Over_Q30,WGS_Min_Aligned_Reads_Delivered,Raw_Mean_Coverage,WGS_Dedup_Coverage,Median_Insert_Size,Raw_Duplication_Rate,WGS_Contamination,Raw_Reads_Count,WTS_Exonic_Rate,WTS_Aligned_Reads,WTS_rRNA_contamination,Concordance,Purity,Yellow_Flags,Red_Flags,Raw_Median_Insert_Size,Raw_Mean_Insert_Size) VALUES ('{Sample}','{WGS_Bases_Over_Q30}','{WGS_Min_Aligned_Reads_Delivered}','{Raw_Mean_Coverage}','{WGS_Dedup_Coverage}','{Median_Insert_Size}','{Raw_Duplication_Rate}','{WGS_Contamination}','{Raw_Reads_Count}','{WTS_Exonic_Rate}','{WTS_Aligned_Reads}','{WTS_rRNA_contamination}','{Concordance}','{Purity}','{Yellow_Flags}','{Red_Flags}','{Raw_Median_Insert_Size}','{Raw_Mean_Insert_Size}')")
