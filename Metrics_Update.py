            ...
            try:
                with h5py.File(filename, 'r') as h5file:
                    try:
                        ...
                        logger.error(f"ERROR: file {filename} for sample {sample} is corrupted.")
                ...
                logger.error(f"ERROR: file {filename} for sample {sample} might have wrong permissions or missing.")
